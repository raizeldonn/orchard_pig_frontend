...
class HomeView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), localStorage.getItem('cartProducts'), () => (0, _Router.gotoRoute)('/game'), () => (0, _Router.gotoRoute)('/products'), () => (0, _Router.gotoRoute)('/'));
