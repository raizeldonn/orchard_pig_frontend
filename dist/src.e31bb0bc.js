...
class ProductsView {
  ...
  initWheel() {
    ...
    var arc = d3.svg.arc().outerRadius(r); // select paths, use arc generator to draw
...
customElements.define('va-app-footer', class AppFooter extends _litElement.LitElement {
  ...
  render() {
    return (0, _litElement.html)(_templateObject(), () => (0, _Router.gotoRoute)('/products'), () => this.hoverFbImage(), () => this.unhoverFbImage(), () => (0, _Router.gotoRoute)('/'));
  }
