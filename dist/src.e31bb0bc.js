...
customElements.define('va-app-header', class AppHeader extends _litElement.LitElement {
  ...
  render() {
    return (0, _litElement.html)(_templateObject(), () => (0, _Router.gotoRoute)('/'), () => (0, _Router.gotoRoute)('/products'), () => (0, _Router.gotoRoute)('/about'), () => (0, _Router.gotoRoute)('/contact'), () => (0, _Router.gotoRoute)('/'), this.hamburgerClick, this.checkoutClick);
  }

  menuToggleAndGo(route) {
    document.getElementById("menu").style.display = 'block' ? 'none' : 'block';
    (0, _Router.gotoRoute)(route);
  }
