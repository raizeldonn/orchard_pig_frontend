...
class Checkout1View {
  ...
  async shippingSubmitHandler(e) {
    e.preventDefault();
    const formData = e.detail.formData;
    document.getElementById('spinner').style = 'display:block;'; // let firstName = formData.get('firstName')
    ...
    if (this.canInfoDisplay == true) {
      for (var i = 0; i < this.products.length; i++) {
        if (this.products[i].shortName === product.shortName && this.products[i].packSize === "12") {
          // this.productDialog.remove();
          product = this.products[i]; //Toast.show("Yummy... Bottled Cider!");
  ...
  moreInfoCanHandler(product) {
    if (this.canInfoDisplay == false) {
      for (var i = 0; i < this.products.length; i++) {
        if (this.products[i].shortName === product.shortName && this.products[i].packSize === "24") {
          // this.productDialog.remove();
          product = this.products[i]; //Toast.show("Delicious... Cider Cans!");
