    ...
    if (this.canInfoDisplay == true) {
      for (var i = 0; i < this.products.length; i++) {
        if (this.products[i].shortName === product.shortName && this.products[i].packSize === "12") {
          ...
          _Toast.default.show("Yummy... Bottled Cider!");

          this.canInfoDisplay = false;
          this.changeCanBottleInfo(product); //this.moreInfoHandler(product);
        }
      }
    }
  } //select can info
    ...
    if (this.canInfoDisplay == false) {
      for (var i = 0; i < this.products.length; i++) {
        if (this.products[i].shortName === product.shortName && this.products[i].packSize === "24") {
          ...
          _Toast.default.show("Delicious... Cider Cans!");
...
customElements.define('va-app-footer', class AppFooter extends _litElement.LitElement {
  ...
  render() {
    return (0, _litElement.html)(_templateObject(), () => (0, _Router.gotoRoute)('/products'), () => (0, _Router.gotoRoute)('/'));
  }

});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","./../Router":"Router.js"}],"components/va-bottle-spinner.js":[function(require,module,exports) {
"use strict";
