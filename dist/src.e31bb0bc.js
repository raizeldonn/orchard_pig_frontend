...
class Auth {
  ...
  async check(success) {
    ...
    if (!localStorage.over18 || localStorage.over18 == false) {
      ...
      (0, _Router.gotoRoute)('/ageconfirm');
      return;
...
exports.default = _default;
},{"./App":"App.js","./Router":"Router.js","./views/partials/splash":"views/partials/splash.js","lit-html":"../node_modules/lit-html/lit-html.js","./Toast":"Toast.js"}],"TeamAPI.js":[function(require,module,exports) {
"use strict";
...
class TeamAPI {
  ...
  async getTeam() {
    ...
    //if(!userId) return
    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase, "/team")); // if response not ok
...
var _TeamAPI = _interopRequireDefault(require("./../../TeamAPI"));
...
exports.default = _default;
},{"./../../App":"App.js","./../../Auth":"Auth.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Utils":"Utils.js"}],"views/pages/about.js":[function(require,module,exports) {
"use strict";
...
class AboutView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), localStorage.getItem('cartProducts')); // this assigns the template html container to App.rootEl
...
exports.default = _default;
},{"./App":"App.js"}],"OrderAPI.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./App":"App.js","./Toast":"Toast.js","./CartAPI":"CartAPI.js"}],"views/pages/checkout1.js":[function(require,module,exports) {
"use strict";
...
class ContactView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), localStorage.getItem('cartProducts'), this.contactSubmitHandler); // this assigns the template html container to App.rootEl
    // which provides the html to the <div id="root"></div> element 
    // in the index.html parent page
...
class ProductsView {
  ...
  moreInfoHandler(product) {
    ...
    this.productDialog.className = 'product-dialog'; // check if the product has cans
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject6(), localStorage.getItem('cartProducts'), this.products == null ? (0, _litHtml.html)(_templateObject7()) : (0, _litHtml.html)(_templateObject8(), this.products.map(product => (0, _litHtml.html)(_templateObject9(), product.containerType == "bottle" ? (0, _litHtml.html)(_templateObject10(), () => this.moreInfoHandler(product), _App.default.apiBase, product.image, product.name, product.name, () => this.moreInfoHandler(product), () => this.hoverImage(product), () => this.unhoverImage(product), product.item, product.name, product.shortName, () => this.addToCart(product)) : (0, _litHtml.html)(_templateObject11()))))); // this assigns the template html container to App.rootEl
    // which provides the html to the <div id="root"></div> element 
    // in the index.html parent page
...
var _game = _interopRequireDefault(require("./views/pages/game"));
...
customElements.define('va-app-footer', class AppFooter extends _litElement.LitElement {
  ...
  render() {
    return (0, _litElement.html)(_templateObject(), () => gotoRoute('/'));
  }

});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js"}],"components/va-bottle-spinner.js":[function(require,module,exports) {
"use strict";
...
customElements.define('va-bottle-spinner', class AppSpinner extends _litElement.LitElement {
  constructor() {
    super();
  }
...
require("./components/va-bottle-spinner");
...
},{"./App.js":"App.js","./components/va-app-header":"components/va-app-header.js","./components/va-app-footer":"components/va-app-footer.js","./components/va-bottle-spinner":"components/va-bottle-spinner.js","./scss/master.scss":"scss/master.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
